...
% 自定义颜色（参考 https://scm.shmtu.edu.cn/photo/2022/0609/c10555a175554/page.htm）
\definecolor{primary_color}{RGB}{0, 44, 118}    % LOGO
\definecolor{secondary_color}{RGB}{0, 44, 118} % LOGO
...
% 学院
\newcommand{\school}{物流科学与工程研究院 | Institute of Logistics Science and Engineering} 
...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \href{mailto:202412312345@stu.shmtu.edu.cn}{{\normalsize\mSymbol{mail}}\quad 202412312345@stu.shmtu.edu.cn}
        \hspace{4em}
        % 手机号
        \href{tel:130-6666-0000}{{\normalsize\mSymbol{call}}\quad 130-6666-0000}
        % 别的联系方式，如微信、GitHub等
        \hspace{4em}
        \href{https://github.com/a645162/SHMTU-CV}{{\normalsize\mSymbol{package-2}}\quad GitHub 项目地址}
    }
}
...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=west](school_logo) at (header.west){
            \hspace{0.5cm}
            \includegraphics[width=0.25\textwidth]{images/海事大学标志-White.eps}
        };
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/logopng.fw.png}
        };
    \end{tikzpicture}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        \begin{minipage}[t]{0.5\textwidth}
            ...
            \vspace{0.5em}
            \textbf{出生年月}：2024/09/29
        \end{minipage}
        \begin{minipage}[t]{0.35\textwidth}
            \textbf{性\qquad 别}：男/女
            
            \vspace{0.5em}
            \textbf{政治面貌}：群众/共青团员/党员
        \end{minipage}
        \vspace{1.2em}
        \end{minipage}
    ...
    \begin{minipage}[t]{0.6\textwidth}
        ...
        \setlength{\itemsep}{0.5em}
            \item 熟练使用 Python、Java、C++、Rust 等编程语言。
            \item 熟练使用 PyTorch、TensorFlow Lite 等深度学习框架。
            \item 熟悉 Windows 、 macOS 以及 Linux 端开发。
        \end{itemize}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.35\textwidth}
